...
namespace LachesBrag.Areas.Admin.Controllers
{
    ...
    public class AdminLanchesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LancheId,Nome,DescricaoCurta,DescricacaoDetalhada,Preco,ImagemUrl,ImagemThumbnailUrl,LanchePreferido,LancheEmEstoque,CategoriaId")] Lanche lanche)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LancheId,Nome,DescricaoCurta,DescricacaoDetalhada,Preco,ImagemUrl,ImagemThumbnailUrl,LanchePreferido,LancheEmEstoque,CategoriaId")] Lanche lanche)
        {
