    ...
    public partial class CarrinhoCompraItem : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarrinoCompraItens", x => x.CarrinhoCompraItemId);
                    table.ForeignKey(
                        name: "FK_CarrinoCompraItens_Lanches_LancheId",
                        column: x => x.LancheId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarrinoCompraItens_LancheId",
